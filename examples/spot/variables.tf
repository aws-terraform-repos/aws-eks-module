# Variables for Spot Instance EKS example

variable "cluster_name" {
  description = "Name of the EKS cluster"
  type        = string
  default     = "spot-eks-cluster"
}
...
# Node Group Variables - Optimized for Spot Instances
variable "node_group_instance_types" {
  description = "Instance types for the EKS node group (multiple types for better spot availability)"
  type        = list(string)
